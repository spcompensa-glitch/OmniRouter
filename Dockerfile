...
RUN --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/var/cache/apt,target=/var/cache/apt,sharing=shared \
  --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/var/lib/apt/lists,target=/var/lib/apt/lists,sharing=shared \
  apt-get update \
  && apt-get upgrade -y \
...
RUN --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/var/cache/apt-builder,target=/var/cache/apt,sharing=shared \
  --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/var/lib/apt/lists-builder,target=/var/lib/apt/lists,sharing=shared \
  apt-get update \
...
RUN --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/root/.npm,target=/root/.npm \
...
COPY . ./
RUN --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/app/.build/next/cache,target=/app/.build/next/cache \
...
RUN --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/var/cache/apt-web,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/var/lib/apt/lists-web,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
...
RUN --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/var/cache/apt-cli,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/var/lib/apt/lists-cli,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
...
RUN --mount=type=cache,id=s/7381b0a7-3aab-4f15-9de3-3e22194da994-/root/.npm-cli,target=/root/.npm \
